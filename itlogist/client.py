...
class ITLogistClient:
    ...
    НОВЫЙ = '1'
    ВЫПОЛНЯЕТСЯ = "50"
    ВЫЕХАЛ_К_ОТПРАВИТЕЛЮ = "100"
    ПЕРЕНОС = "101"
    НЕДОЗВОН_ДО_ОТПРАВИТЕЛЯ = "105"
    ОТКАЗ_ОТ_ОТПРАВЛЕНИЯ = "107"
    ДОЗВОНИЛСЯ = "109"
    ОТПРАВЛЕНИЕ_У_КУРЬЕРА = "200"
    ВЫЕХАЛ_К_ПОЛУЧАТЕЛЮ = "300"
    ПЕРЕНОС = "301"
    НЕДОЗВОН_ДО_ПОЛУЧАТЕЛЯ = "305"
    ОТКАЗ_ОТ_ПОЛУЧЕНИЯ = "307"
    ДОСТАВКА_ДОЗВОНИЛСЯ = "309"
    ВОЗВРАТ_ОТПРАВЛЕНИЯ = "500"
    ВЫПОЛНЕН = "700"
    ВОЗВРАЩЕН = "705"
    ОТМЕНЕН = "707"
